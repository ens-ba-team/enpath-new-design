  ...
  getHighlighter(language)
    ...
    .then((highlighter) => {
      ...
      const result = highlighter.codeToTokens(code, {
        lang: langToUse,
        // Light mode only (Enpath) — no dark highlighting theme
        themes: {
          light: "github-light",
        },
      });
...
export const CodeBlockContainer = ({
  ...
  <div
    className={cn(
      "group relative w-full overflow-hidden rounded-md border bg-[var(--color-background-default)] text-[var(--color-background-default-foreground)]",
      className
    )}
