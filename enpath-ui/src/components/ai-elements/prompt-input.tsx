...
import { ArrowElbowDownLeftIcon, ImageIcon, MonitorIcon, PlusIcon, StopIcon, XIcon } from "@phosphor-icons/react/ssr";
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side={side}>
        {tooltipContent}
        {shortcut && (
          <span className="ml-2 text-[var(--color-text-secondary)]">{shortcut}</span>
        )}
      </TooltipContent>
    </Tooltip>
  );
